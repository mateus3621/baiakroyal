...
$config['pagSeguro']['email'] = 'mmabaiakot@gmail.com';
$config['pagSeguro']['token'] = '9888B5D5E33F4693AFCFB56BD17E34D4';
$config['pagSeguro']['urlRedirect'] = 'http://baiakroyal.servegame.com/index.php?subtopic=shopsystem';
$config['pagSeguro']['urlNotification'] = 'http://baiakroyal.servegame.com/retpagseguro.php';
$config['pagSeguro']['productName'] = 'Premium Points';
$config['pagSeguro']['productValue'] = 1.00;
$config['pagSeguro']['doublePoints'] = true;
$config['pagSeguro']['host'] = 'localhost';
$config['pagSeguro']['database'] = 'otserv';
$config['pagSeguro']['databaseUser'] = 'root';
$config['pagSeguro']['databasePass'] = 'zAg6SWenadRA';

# Account Maker Config
$config['site']['serverPath'] = "/otserv/";
$config['site']['useServerConfigCache'] = false;
$config['site']['worlds'] = array(0 => 'Royal-OT');
$towns_list[0] = array(1 => 'Royal-OT');

$config['site']['outfit_images_url'] = 'http://outfit-images.ots.me/';
$config['site']['outfit_images_url'] = 'http://outfit-images.ots.me/';
...
$config['site']['mail_address'] = "mmabaiakot@gmail.com";
$config['site']['smtp_enabled'] = true;
$config['site']['smtp_host'] = "smtp.gmail.com";
$config['site']['smtp_port'] = "587";
$config['site']['smtp_auth'] = true;
$config['site']['smtp_user'] = "mmabaiakot@gmail.com";
$config['site']['smtp_pass'] = "mmaserver3621";
